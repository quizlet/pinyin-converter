...
(function() {
  ...
  window.PinyinConverter = {
    ...
    convert: function(string) {
      var match, matches, replacement, _i, _len;
    ...
    getReplacement: function(match) {
      var accentMap, base, replacedWord, replacement, tone, vowel, vowelNum, word;
      accentMap = this.getAccentMap();
      tone = match.slice(-1);
      word = match.slice(0, -1).replace('v', 'ü').replace('V', 'Ü');
      for (base in accentMap) {
        vowel = accentMap[base];
        vowelNum = this.vowels[vowel];
        replacement = this.pinyin[tone.toString()][vowelNum];
    ...
    getAccentMap: function() {
      var base, i, nostars, stars, starsArray, _i, _len, _ref;
      if (!this.accentMap) {
        stars = 'a* e* i* o* u* ü* ' + 'A* E* I* O* U* Ü* ' + 'a*i a*o e*i ia* ia*o ie* io* iu* ' + 'A*I A*O E*I IA* IA*O IE* IO* IU* ' + 'o*u ua* ua*i ue* ui* uo* üe* ' + 'O*U UA* UA*I UE* UI* UO* ÜE*';
